...
namespace CatalogService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ICatalogBrandsRepository, CatalogBrandsRepository>();
            services.AddTransient<ICatalogTypesRepository, CatalogTypesRepository>();
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                endpoints.MapGrpcService<CatalogServiceImpl>();
